 ...
 */
package com.msj.batch.framework.configuration;
 ...
 * {@link BatchConfigurer} interface. The main components are created as lazy
 * proxies that only initialize when a method is called. This is to prevent (as
 * much as possible) configuration cycles from developing when these components
 * are needed in a configuration resource that itself provides a
